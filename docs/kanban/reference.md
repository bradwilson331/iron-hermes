...
> Canonical product reference for IronHermes Kanban. Pinned by phase 36.3.7 as
> the source of truth for the kanban feature surface. Supersedes any conflicting
> guidance in `docs/hermes-kanban-v1-spec.pdf` (the design rationale) where the
> two disagree. Sourced from the Hermes reference page on 2026-05-29.
