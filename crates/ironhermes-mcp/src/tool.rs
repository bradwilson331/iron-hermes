...
///
/// Hyphens and dots in server or tool names are replaced with underscores
/// before joining with double-underscore. This matches hermes-agent's
/// `_convert_mcp_schema` sanitization.
///
/// # Examples
/// ```
