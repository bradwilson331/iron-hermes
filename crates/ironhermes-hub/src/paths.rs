...
/// Root directory for installed skills: $IRONHERMES_HOME/skills or ~/.ironhermes/skills.
...
/// D-10: skills-lock.json lives at `$IRONHERMES_HOME/skills-lock.json` (sibling of the
/// skills/ directory), NOT inside skills/. This differs from `manifest_path()` which
/// returns `$IRONHERMES_HOME/skills/.hub/lock.json` (19.1 location, retained for migration).
