...
- **Fix:** Not fixed. Logged to `/Users/you/code/iron_hermes_ui/.planning/phases/01-hygiene/deferred-items.md` per executor scope-boundary rules — the warning is not caused by Plan 01-03's Cargo.lock work, and `src/main.rs` is already committed by Plan 01-02. Touching it now would mix concerns across plans.
