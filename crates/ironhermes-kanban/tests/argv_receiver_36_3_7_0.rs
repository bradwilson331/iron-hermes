...
fn build_kanban_worker_env_emits_skills_env_when_task_has_extras() {
    ...
    let env = build_kanban_worker_env(&task, &run, "/tmp/ws_skills", "default", None);
...
fn build_kanban_worker_env_omits_skills_env_when_task_has_none() {
    ...
    let env = build_kanban_worker_env(&task, &run, "/tmp/ws_no_skills", "default", None);
...
fn build_kanban_worker_env_omits_skills_env_when_task_has_empty_array() {
    ...
    let env = build_kanban_worker_env(&task, &run, "/tmp/ws_empty_skills", "default", None);
