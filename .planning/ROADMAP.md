...
- [ ] 36.17.2-03-PLAN.md — Integration test tests/uqm_session_queue_unification.rs: 5 same-chat messages → 5 👁 at pop in FIFO order through real handle_with_multimodal; multimodal round-trip test; worker-exit/dispatch race coverage; verify 9 existing tests in session_queue_integration.rs still pass unchanged (D-20, D-21)
