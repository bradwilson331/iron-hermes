...
**Plans:** 4 plans
Plans:
- [ ] 12-01-PLAN.md — ProviderResolver, ApiMode, ResolvedEndpoint types and Config extension
- [ ] 12-02-PLAN.md — AnthropicClient, message format adapter, AnyClient enum dispatch
- [ ] 12-03-PLAN.md — Shared iteration budget and one-shot fallback provider switching
...
| 12. Provider Resolution | v2.0 | 0/4 | Planned | - |
