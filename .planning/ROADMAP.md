...
Plans:
- [ ] 28.1-01-PLAN.md — AgentRuntime budget-reset regression test (foundational proof; agent crate)
- [ ] 28.1-02-PLAN.md — Gateway → run_turn; remove 367eaa79 band-aid (highest value)
- [ ] 28.1-03-PLAN.md — Web UI → run_turn; close top-level-loop budget gap
- [ ] 28.1-04-PLAN.md — CLI run_chat + run_single → run_turn; fix run_chat latch
- [ ] 28.1-05-PLAN.md — TUI → run_turn; fix latch + max_turns/max_iterations drift
- [ ] 28.1-06-PLAN.md — Cron distinct runtime/budget (§6.4); preserve per-job overrides
