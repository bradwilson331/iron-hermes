...
**Plans:** 4 plans across 3 waves (Wave 1: Plans 01+02 parallel, file-disjoint; Wave 2: Plan 03; Wave 3: Plan 04 docs + §5 LIVE UAT checkpoint)

Plans:
- [ ] 36.3.7.13-01-PLAN.md — F-01 cross-profile DB resolution: KanbanStore::open_from_env() + open_from_env_or_board(slug) + swap 25 dispatcher-bridged sites (CLI/gateway/dashboard/11 LLM tools); 5 bilateral tests (D-A1/D-A2/D-H1). Wave 1, parallel with 02.
- [ ] 36.3.7.13-02-PLAN.md — F-02 IRONHERMES_WORKER_BIN override: resolve_worker_bin() helper + Command::new swap + SAFE_SYSTEM_VARS 8th entry; 4 bilateral tests. Wave 1, parallel with 01 (file-disjoint).
