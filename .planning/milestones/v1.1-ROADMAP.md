...
- [x] 09-03-PLAN.md — Batch delegation mode, toolset groups, model override, expanded config
- [x] 09-04-PLAN.md — CancellationToken propagation, detach flag, CLI tree-view progress
